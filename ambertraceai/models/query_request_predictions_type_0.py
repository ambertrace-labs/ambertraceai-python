...
if TYPE_CHECKING:
    from ..models.query_request_predictions_type_0_additional_property import (
        QueryRequestPredictionsType0AdditionalProperty,
    )


T = TypeVar("T", bound="QueryRequestPredictionsType0")
...
class QueryRequestPredictionsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query_request_predictions_type_0 = cls()
        ...
        query_request_predictions_type_0.additional_properties = additional_properties
        return query_request_predictions_type_0
