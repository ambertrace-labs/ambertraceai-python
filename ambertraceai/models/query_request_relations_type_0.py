...
if TYPE_CHECKING:
    from ..models.query_request_relations_type_0_additional_property_item import (
        QueryRequestRelationsType0AdditionalPropertyItem,
    )


T = TypeVar("T", bound="QueryRequestRelationsType0")
...
class QueryRequestRelationsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query_request_relations_type_0 = cls()
        ...
        query_request_relations_type_0.additional_properties = additional_properties
        return query_request_relations_type_0
