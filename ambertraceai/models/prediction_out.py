...
class PredictionOut:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_explanation(data: object) -> None | PredictionOutExplanationType0 | Unset:
            if data is None:
                return data
        ...
        unmatched_overrides = _parse_unmatched_overrides(d.pop("unmatched_overrides", UNSET))
